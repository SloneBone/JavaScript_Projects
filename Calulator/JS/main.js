...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for any expressions, we set it to tnull for now
    First_Operand: null, 
...
function Handle_Operator(Next_Operator)     {
    ...
    if (First_Operand == null)  {
        ...
        //in the Perform_Calclulations object and the function that matches the 
...
keys.addEventListener('click', (Event) => {
    ...
    const { target } = Event;
    //if the element that was clicked on is not a button, exit the fuction
